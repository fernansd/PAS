...
/*
Utilizando el comando kill, prueba a mandar señales a este programa. Ejecuta el programa en el background:
...
int main()
{
	...
	for(;;)
		//No hago nada,solo quedo a la espera de señales tipo SIGUSR1 
		pause();
